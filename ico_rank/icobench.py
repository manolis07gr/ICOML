...
#################################################################################################
    ...
    [ICO_s,ICO_e,ICO_duration,country,team,ico_raised,ICO_p,ICO_hardcap,success,ICO_industry,ICO_Telegram_N] = ['N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A']
    ...
    try:
        for a in soup_c.find_all('a', href=True):
            if ('https://t.me/' in a['href']) and ('joinchat' not in a['href']) and a['href'] != 'https://t.me/icobench':
    ...
    try:
        ...
        response2 = requests.get(source2)
        txt2 = response2.text
    ...
    if (success != 'N/A') and (ico_raised != 'N/A'):
        try:
            ICO_hardcap = round(ico_raised/success,1)
        except:
            ICO_hardcap = 'N/A'
