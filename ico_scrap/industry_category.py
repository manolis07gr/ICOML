def func_industry(industry):
	...
	saas = ['saas','computing','data storage','datastorage','computing & data storage','software as a service','softwareasaservice','software','data services','cloud services','dataservices','cloudservices','cloud','cloud storage','cloudstorage','data','big data','internet','platform','protocol','marketing','advertising','business services','consulting','identity','verification','security','app','it','marketing & advertising','computing & data storage','computing&datastorage','data analytics','dataanalytics','identity & reputation','privacy & security','recruitment & crowdsourcing','translation','writing & editing','artifician intelligence','big data','big data & data storage','content management','machine learning']
