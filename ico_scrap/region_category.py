def func_region(region):
	...
	region6 = ['switzerland']
	region7 = ['singapore','cayman islands','gibraltar','seychelles','isle of man','isleofman','virgin islands','british virgin islands','britishvirginislands','virginislands','philippines']
