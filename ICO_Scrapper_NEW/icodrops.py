...
#################################################################################################
    ...
    try:
        response = requests.get('https://icodrops.com/'+currency,headers={'User-Agent': 'Mozilla/5.0'})
        txt = response.text
        soup_s2 = BeautifulSoup(txt, 'html.parser')
    except:
        txt = 'N/A'
        soup_s2 = 'N/A'
        country,industry,team,raised,hardcap,success,price,telegram = ['N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A']

    [country2,ICO_industry2,team2,ico_raised2,ICO_hardcap2,success2,ICO_p2,ICO_Telegram_N2] = ['N/A','N/A','N/A','N/A','N/A','N/A','N/A','N/A']
    ...
    try:
        ...
        response2 = requests.get(source22)
        txt2 = response2.text
        soup_ccc = BeautifulSoup(txt2, 'html.parser')
