...
with open('nan_coins_wr.txt', 'r') as myfile:
...
with open('outdata/ico_data_full_wr_nans.csv', 'w') as csvfile1, open('outdata/ico_data_reduced_wr_nans.csv', 'w') as csvfile2, open('outdata/ico_data_reduced_wratings_wr_nans.csv', 'w') as csvfile3:
