...
with open('nan_coins2_wr.txt', 'r') as myfile:
...
with open('outdata/ico_data_full_nans2_wr.csv', 'w') as csvfile1, open('outdata/ico_data_reduced_nans2_wr.csv', 'w') as csvfile2, open('outdata/ico_data_reduced_wratings_nans2_wr.csv', 'w') as csvfile3:
