...
var isMatchingDef = exports.isMatchingDef = function isMatchingDef(predicate, node, dataKey) {
    if (predicate === '*') {
        return true;
    } else if ((0, _lodash.isFunction)(predicate)) {
        return predicate(node);
    } else if ((0, _lodash.isPlainObject)(predicate)) {
        var data = dataKey ? (0, _lodash.get)(node, dataKey) : node;
        return (0, _lodash.isEqual)((0, _lodash.pick)(data, Object.keys(predicate)), predicate);
    }
                    ...
                    if (def) {
                        if (patternKeys.includes(def.type)) {
                            if (def.background === 'inherit' || def.color === 'inherit') {
                                var nodeColor = (0, _lodash.get)(node, colorKey);
                                ...
                                (0, _lodash.set)(node, targetKey, 'url(#' + inheritedId + ')');
                                ...
                                (0, _lodash.set)(node, targetKey, 'url(#' + id + ')');
                            }
                            ...
                            if (allColors.includes('inherit')) {
                                var _nodeColor = (0, _lodash.get)(node, colorKey);
                                ...
                                (0, _lodash.set)(node, targetKey, 'url(#' + _inheritedId + ')');
