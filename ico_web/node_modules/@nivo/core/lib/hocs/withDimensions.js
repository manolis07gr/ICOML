...
exports.default = function () {
    return (0, _compose2.default)((0, _defaultProps2.default)({
        margin: _defaults.defaultMargin
    }), (0, _setPropTypes2.default)({
        width: _propTypes2.default.number.isRequired,
        height: _propTypes2.default.number.isRequired,
        margin: _props.marginPropType
    }), (0, _withPropsOnChange2.default)(function (props, nextProps) {
        return props.width !== nextProps.width || props.height !== nextProps.height || !(0, _lodash.isEqual)(props.margin, nextProps.margin);
    }, function (props) {
