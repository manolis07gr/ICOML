...
var RadarGridLevels = function RadarGridLevels(_ref) {
        ...
        if (animate !== true) {
            return _react2.default.createElement(
                ...
                radii.map(function (r, i) {
                    return _react2.default.createElement('circle', _extends({ key: 'level.' + i, fill: 'none', r: r }, theme.grid));
                })
            );
        }
                ...
                return _react2.default.createElement(
                    ...
                    interpolatedStyles.map(function (_ref2) {
                        var key = _ref2.key,
                            style = _ref2.style,
                            data = _ref2.data;
                        return _react2.default.createElement('circle', _extends({ key: key, fill: 'none', r: style.r }, theme.grid));
                    })
                );
            }
        );
    ...
    var radarLineGenerator = (0, _d3Shape.lineRadial)().angle(function (i) {
        return i * angleStep;
    }).curve(_d3Shape.curveLinearClosed);

    var points = (0, _lodash.range)(dataLength);
