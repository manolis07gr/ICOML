...
var RadarDots = function (_Component) {
    ...
    RadarDots.prototype.render = function render() {
        ...
        var fillColor = (0, _core.getInheritedColorGenerator)(color);
        var strokeColor = (0, _core.getInheritedColorGenerator)(borderColor);
        ...
        var points = data.reduce(function (acc, datum, i) {
            ...
            keys.forEach(function (key) {
                ...
                acc.push({
                    ...
                    }, (0, _core.positionFromAngle)(angleStep * i - Math.PI / 2, radiusScale(datum[key]))),
                    data: pointData
                });
            });
...
RadarDots.propTypes = _extends({
    ...
    color: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.func]).isRequired,
    borderWidth: _propTypes2.default.number.isRequired,
    borderColor: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.func]).isRequired,
