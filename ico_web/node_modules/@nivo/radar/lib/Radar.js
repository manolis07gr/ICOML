...
Radar.propTypes = {
    ...
    curve: _core.closedCurvePropType.isRequired,
...
var enhance = (0, _compose2.default)((0, _defaultProps2.default)(RadarDefaultProps), (0, _core.withTheme)(), (0, _core.withColors)({
    defaultColorBy: 'key'
}), (0, _core.withCurve)(), (0, _core.withDimensions)(), (0, _core.withMotion)(), (0, _withPropsOnChange2.default)(['indexBy'], function (_ref3) {
    ...
    var maxValue = (0, _lodash.max)(data.reduce(function (acc, d) {
