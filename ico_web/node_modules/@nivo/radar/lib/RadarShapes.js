    ...
    return _react2.default.createElement(
        ...
        keys.map(function (key) {
            return _react2.default.createElement(
                ...
                function (style) {
                    return _react2.default.createElement('path', _extends({ fillOpacity: fillOpacity, strokeWidth: borderWidth }, style));
                }
            );
        })
    );
...
var enhance = (0, _compose2.default)((0, _withPropsOnChange2.default)(['borderColor'], function (props) {
    return {
        borderColor: (0, _core.getInheritedColorGenerator)(props.borderColor)
    };
}), (0, _withPropsOnChange2.default)(['radiusScale', 'angleStep', 'curveInterpolator'], function (_ref2) {
    var radiusScale = _ref2.radiusScale,
        angleStep = _ref2.angleStep,
        curveInterpolator = _ref2.curveInterpolator;
    return {
        lineGenerator: (0, _d3Shape.lineRadial)().radius(function (d) {
