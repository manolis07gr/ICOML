...
var RadarTooltipItem = function RadarTooltipItem(_ref) {
    ...
    return _react2.default.createElement(
        'g',
        null,
        _react2.default.createElement('line', { x1: 0, y1: 0, x2: tipX, y2: tipY, stroke: '#000', strokeOpacity: isHover ? 0.35 : 0 }),
...
RadarTooltipItem.propTypes = {
    datum: _propTypes2.default.oneOfType([_propTypes2.default.object, _propTypes2.default.array]).isRequired,
...
var enhance = (0, _compose2.default)((0, _withState2.default)('isHover', 'setIsHover', false), (0, _withPropsOnChange2.default)(['datum', 'keys', 'index', 'colorByKey', 'theme', 'tooltipFormat'], function (_ref2) {
    ...
    return {
        tooltip: _react2.default.createElement(_core.TableTooltip, {
            title: _react2.default.createElement(
                'strong',
                null,
                index
            ),
            rows: (0, _lodash.sortBy)(keys.map(function (key) {
                return [_react2.default.createElement(_core.Chip, { color: colorByKey[key] }), key, format ? format(datum[key]) : datum[key]];
            }), '2').reverse(),
            theme: theme
        })
    };
}), (0, _withPropsOnChange2.default)(['startAngle', 'endAngle', 'radius', 'arcGenerator'], function (_ref3) {
    var startAngle = _ref3.startAngle,
        endAngle = _ref3.endAngle,
        radius = _ref3.radius,
        arcGenerator = _ref3.arcGenerator;

    var position = (0, _core.positionFromAngle)(startAngle + (endAngle - startAngle) * 0.5 - Math.PI / 2, radius);
