...
var commonEnhancers = [(0, _core.withHierarchy)(), (0, _core.withDimensions)(), (0, _core.withTheme)(), (0, _core.withColors)({ defaultColorBy: 'depth' }), (0, _withPropsOnChange2.default)(['width', 'height', 'padding'], function (_ref) {
    ...
    return {
        getIdentity: (0, _core.getAccessorFor)(identity)
    };
}),
...
(0, _withPropsOnChange2.default)(['label', 'labelFormat'], function (_ref4) {
    ...
    return {
        getLabelTextColor: (0, _core.getInheritedColorGenerator)(labelTextColor)
    };
}),
...
(0, _withStateHandlers2.default)(function (_ref6) {
    ...
    var nodes = (0, _compute.computeNodes)({ root: root, pack: pack, leavesOnly: leavesOnly, getIdentity: getIdentity, getColor: getColor });
    ...
    if (currentNodePath && isZoomable) {
        return {
            nodes: (0, _compute.computeZoom)(nodes, currentNodePath, width, height)
        };
    }
})];
...
var svgEnhancers = [(0, _withPropsOnChange2.default)(['nodes', 'defs', 'fill'], function (_ref11) {
    ...
    return {
        defs: (0, _core.bindDefs)(defs, nodes, fill, { targetKey: 'fill' })
    };
})];
...
exports.default = function (Component) {
    ...
    switch (Component.displayName) {
        case 'Bubble':
            return _compose2.default.apply(undefined, [(0, _defaultProps2.default)(implDefaultProps)].concat(commonEnhancers, svgEnhancers, [(0, _core.withMotion)(), _pure2.default]))(Component);

        case 'BubbleHtml':
            return _compose2.default.apply(undefined, [(0, _defaultProps2.default)(implDefaultProps)].concat(commonEnhancers, [(0, _core.withMotion)(), _pure2.default]))(Component);
